...
ALTER TABLE vicidial_auto_calls ENGINE=InnoDB;
ALTER TABLE vicidial_call_times ENGINE=InnoDB;
ALTER TABLE vicidial_callbacks ENGINE=InnoDB;
ALTER TABLE vicidial_campaign_agents ENGINE=InnoDB;
ALTER TABLE vicidial_campaign_hotkeys ENGINE=InnoDB;
ALTER TABLE vicidial_campaign_server_stats ENGINE=InnoDB;
ALTER TABLE vicidial_campaign_stats ENGINE=InnoDB;
ALTER TABLE vicidial_campaign_statuses ENGINE=InnoDB;
ALTER TABLE vicidial_campaigns ENGINE=InnoDB;
ALTER TABLE vicidial_campaigns_list_mix ENGINE=InnoDB;
ALTER TABLE vicidial_closer_log ENGINE=InnoDB;
ALTER TABLE vicidial_conferences ENGINE=InnoDB;
ALTER TABLE vicidial_dnc ENGINE=InnoDB;
ALTER TABLE vicidial_hopper ENGINE=InnoDB;
ALTER TABLE vicidial_inbound_group_agents ENGINE=InnoDB;
ALTER TABLE vicidial_inbound_groups ENGINE=InnoDB;
ALTER TABLE vicidial_ivr ENGINE=InnoDB;
ALTER TABLE vicidial_lead_filters ENGINE=InnoDB;
ALTER TABLE vicidial_lead_recycle ENGINE=InnoDB;
ALTER TABLE vicidial_list ENGINE=InnoDB;
ALTER TABLE vicidial_list_pins ENGINE=InnoDB;
ALTER TABLE vicidial_lists ENGINE=InnoDB;
ALTER TABLE vicidial_live_agents ENGINE=InnoDB;
ALTER TABLE vicidial_live_inbound_agents ENGINE=InnoDB;
ALTER TABLE vicidial_log ENGINE=InnoDB;
ALTER TABLE vicidial_manager ENGINE=InnoDB;
ALTER TABLE vicidial_pause_codes ENGINE=InnoDB;
ALTER TABLE vicidial_phone_codes ENGINE=InnoDB;
ALTER TABLE vicidial_postal_codes ENGINE=InnoDB;
ALTER TABLE vicidial_remote_agents ENGINE=InnoDB;
ALTER TABLE vicidial_scripts ENGINE=InnoDB;
ALTER TABLE vicidial_server_trunks ENGINE=InnoDB;
ALTER TABLE vicidial_state_call_times ENGINE=InnoDB;
ALTER TABLE vicidial_stations ENGINE=InnoDB;
ALTER TABLE vicidial_status_categories ENGINE=InnoDB;
ALTER TABLE vicidial_statuses ENGINE=InnoDB;
ALTER TABLE vicidial_user_groups ENGINE=InnoDB;
ALTER TABLE vicidial_user_log ENGINE=InnoDB;
ALTER TABLE vicidial_users ENGINE=InnoDB;
ALTER TABLE vicidial_xfer_log ENGINE=InnoDB;
ALTER TABLE web_client_sessions ENGINE=InnoDB;

#Create some custom indexes.
create index country_postal ON vicidial_postal_codes (country_code,postal_code);
create index country_area ON vicidial_phone_codes (country_code,areacode);
...
#index vicidial_agent_log - 2008-10-22 23:12
create index time_user ON vicidial_agent_log (event_time,user);

#index vicidial closer/xfer logs
...
# 02/11/2009
CREATE TABLE vicidial_campaign_forms (
        id INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE vicidial_campaign_fields (
        id INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE vicidial_list_fields (
        id INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
        lead_id INT(10) UNSIGNED NOT NULL,
...
INSERT INTO vicidial_campaign_forms values('1','ALL','CREDITCARD','Details as They Appear on CC','(if different)','1','0');
INSERT INTO vicidial_campaign_fields values('1','1','NAME','Name on Card','','22','1','0');
INSERT INTO vicidial_campaign_fields values('2','1','ADDRESS','Billing Address','','22','2','0');
INSERT INTO vicidial_campaign_fields values('3','1','CITY','City','','22','3','0');
INSERT INTO vicidial_campaign_fields values('4','1','STATE','State','','3','4','0');
INSERT INTO vicidial_campaign_fields values('5','1','ZIP','ZIP','','10','5','0');
INSERT INTO vicidial_campaign_fields values('6','1','TYPE','CC Type','VISA,Master Card,American Express','22','6','0');
INSERT INTO vicidial_campaign_fields values('7','1','NUMBER','CC Number','','22','7','0');
INSERT INTO vicidial_campaign_fields values('8','1','CVV','CVV Code','','5','8','0');
