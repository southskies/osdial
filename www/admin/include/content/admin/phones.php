...
if ($ADD==11111111111)
{
	...
	echo "<tr bgcolor=$oddrows><td align=right>Company: </td><td align=left><input type=text name=company size=10 maxlength=10 value=\"$row[12]\">$NWB#phones-company$NWE</td></tr>\n";
...
if ($ADD==31111111111)
{
	...
	echo "<TABLE width=$section_width cellspacing=3>\n";
	echo "<tr bgcolor=$oddrows><td align=right>Phone extension: </td><td align=left><input type=text name=extension size=20 maxlength=100 value=\"$row[0]\">$NWB#phones-extension$NWE</td></tr>\n";
	echo "<tr bgcolor=$oddrows><td align=right>Dial Plan Number: </td><td align=left><input type=text name=dialplan_number size=15 maxlength=20 value=\"$row[1]\"> (digits only)$NWB#phones-dialplan_number$NWE</td></tr>\n";
	echo "<tr bgcolor=$oddrows><td align=right>Voicemail Box: </td><td align=left><input type=text name=voicemail_id size=10 maxlength=10 value=\"$row[2]\"> (digits only)$NWB#phones-voicemail_id$NWE</td></tr>\n";
	echo "<tr bgcolor=$oddrows><td align=right>Outbound CallerID: </td><td align=left><input type=text name=outbound_cid size=10 maxlength=20 value=\"$row[65]\"> (digits only)$NWB#phones-outbound_cid$NWE</td></tr>\n";
	echo "<tr bgcolor=$oddrows><td align=right>Phone IP address: </td><td align=left><input type=text name=phone_ip size=20 maxlength=15 value=\"$row[3]\"> (optional)$NWB#phones-phone_ip$NWE</td></tr>\n";
	...
	echo "<tr bgcolor=$oddrows><td align=right>OSDial Default Agent: </td><td align=left><input type=text name=login_user size=20 maxlength=20 value=\"$row[20]\">$NWB#phones-login_user$NWE</td></tr>\n";
	echo "<tr bgcolor=$oddrows><td align=right>OSDial Default Pass: </td><td align=left><input type=text name=login_pass size=20 maxlength=20 value=\"$row[21]\">$NWB#phones-login_pass$NWE</td></tr>\n";
	echo "<tr bgcolor=$oddrows><td align=right>OSDial Default Campaign: </td><td align=left><input type=text name=login_campaign size=10 maxlength=10 value=\"$row[22]\">$NWB#phones-login_campaign$NWE</td></tr>\n";
	...
	echo "<tr bgcolor=$oddrows><td align=right>OSDial Park Exten: </td><td align=left><input type=text name=OSDIAL_park_on_extension size=10 maxlength=10 value=\"$row[25]\">$NWB#phones-OSDial_park_on_extension$NWE</td></tr>\n";
	echo "<tr bgcolor=$oddrows><td align=right>OSDial Park File: </td><td align=left><input type=text name=OSDIAL_park_on_filename size=10 maxlength=10 value=\"$row[26]\">$NWB#phones-OSDial_park_on_filename$NWE</td></tr>\n";
	...
	echo "<tr bgcolor=$oddrows><td align=right>OSDial Default URL: </td><td align=left><input type=text name=OSDIAL_web_URL size=40 maxlength=255 value=\"$row[37]\">$NWB#phones-OSDial_web_URL$NWE</td></tr>\n";
