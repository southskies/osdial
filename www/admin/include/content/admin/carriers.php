...
//             echo "<span class=no-ul><a href=\"$PHP_SELF?ADD=3carrier&SUB=2&carrier_id=$carrier_id\">RETURN TO CARRIER</a></span><br><br>\n";
            ...
            echo "    <td align=left>\n";
            echo "      <div>\n";
            echo "      <select name=did_action onchange=\"fixChromeTableExpand2('INGROUP');fixChromeTableExpand2('PHONE');fixChromeTableExpand2('EXTENSION');fixChromeTableExpand2('VOICEMAIL');selaction(this);fixChromeTableCollapse();return false;\">\n";
            ...
            echo "".helptag("carrier_dids-voicemail")."</div></td>\n";
            echo "  </tr>\n";
            ...
            echo "".helptag("carrier_dids-park_file")."</div></td>\n";
            echo "  </tr>\n";
            echo "  <tr bgcolor=$oddrows name=INGROUP style=\"visibility:visible;\">\n";
            ...
            echo "".helptag("carrier_dids-default_list_id")."</div></td>\n";
            echo "  </tr>\n";
            echo "  <tr bgcolor=$oddrows name=INGROUP style=\"visibility:visible;\">\n";
            echo "    <td align=right>Default Phone (country) Code:</td>\n";
            echo "    <td align=left><div><input type=text name=did_default_phone_code size=5 maxlength=5 value=\"1\">".helptag("carrier_dids-default_phone_code")."</div></td>\n";
            echo "  </tr>\n";
            echo "  <tr bgcolor=$oddrows name=INGROUP style=\"visibility:visible;\">\n";
        ...
        ### SUB=2  New Carrier
            ...
            echo "<center>\n";
            echo "<br><font class=no-ul color=$default_text size=+1>ADD A NEW CARRIER</font><br><br>\n";
            echo "<form name=osdial_form action=$PHP_SELF method=POST>\n";
            echo "<input type=hidden name=ADD value=2carrier>\n";
            echo "<input type=hidden name=SUB value=$SUB>\n";
            echo "<table width=$section_width cellspacing=3>\n";
...
//             echo "<span class=no-ul><a href=\"$PHP_SELF?ADD=3carrier&SUB=2&carrier_id=$carrier_id\">RETURN TO CARRIER</a></span><br><br>\n";
            ...
            echo "  <tr bgcolor=$oddrows name=INGROUP style=\"$istyle\">\n";
            echo "    <td align=right>Default Phone (country) Code:</td>\n";
            echo "    <td align=left><div><input type=text name=did_default_phone_code size=5 maxlength=5 value=\"$gfr[default_phone_code]\">".helptag("carrier_dids-default_phone_code")."</div></td>\n";
            echo "  </tr>\n";
            echo "  <tr bgcolor=$oddrows name=INGROUP style=\"$istyle\">\n";
            echo "    <td align=right>Search Campaign:</td>\n";
            echo "    <td align=left>\n";
...
//             echo "<br><br><a href=\"$PHP_SELF?ADD=5carrier&SUB=$SUB&carrier_server_ip=$carrier_server_ip&carrier_id=$carrier_id\">DELETE THESE SERVER OPTIONS</a>\n";
        ...
        ### SUB=2  Carrier Form
            ...
            $gfr = get_first_record($link, 'osdial_carriers', '*', sprintf("id='%s'",mres($carrier_id)));
            echo "<center>\n";
            echo "<br><font class=top_header color=$default_text size=+1>MODIFY CARRIER</font><br><br>\n";
            echo "<form name=osdial_form action=$PHP_SELF method=POST>\n";
            echo "<input type=hidden name=ADD value=4carrier>\n";
            echo "<input type=hidden name=SUB value=$SUB>\n";
...
//             echo "  <br><a href=\"$PHP_SELF?ADD=1carrier&SUB=2&carrier_id=$carrier_id\">ADD NEW CARRIER</a>\n";
        ...
        echo "<script type=\"text/javascript\">\n";
	echo "fixChromeTableExpand2('INGROUP');fixChromeTableExpand2('PHONE');fixChromeTableExpand2('EXTENSION');fixChromeTableExpand2('VOICEMAIL');fixChromeTableCollapse();\n";
        include "carriers.js";
        if ($ANC==1) {
