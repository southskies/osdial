...
if ($ADD==1111111111111)
{
	...
	echo "<tr bgcolor=$oddrows><td align=right>Number: </td><td align=left><input type=text name=conf_exten size=8 maxlength=7> (digits only)".helptag("conferences-conf_exten")."</td></tr>\n";
...
if ($ADD==3111111111111)
{
	...
	echo "<TABLE class=shadedtable width=$section_width cellspacing=3>\n";
	echo "<tr bgcolor=$oddrows><td align=right>Number: </td><td align=left><input type=text name=conf_exten size=10 maxlength=7 value=\"$row[0]\">".helptag("conferences-conf_exten")."</td></tr>\n";
