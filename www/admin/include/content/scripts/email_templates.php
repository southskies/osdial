...
if ($ADD=="7email") {
    ...
    $et_text = eregi_replace('\[\[list_id\]\]',             $list_id,             $et_text);
    $et_text = eregi_replace('\[\[gmt_offset_now\]\]',      $gmt_offset_now,      $et_text);
    $et_text = eregi_replace('\[\[fullname\]\]',            $fullname,            $et_text);
    $et_text = eregi_replace('\[\[fronter\]\]',             $fronter,             $et_text);
    $et_text = eregi_replace('\[\[user\]\]',                $user,                $et_text);
    $et_text = eregi_replace('\[\[pass\]\]',                $pass,                $et_text);
    $et_text = eregi_replace('\[\[lead_id\]\]',             $lead_id,             $et_text);
    $et_text = eregi_replace('\[\[campaign\]\]',            $campaign,            $et_text);
    $et_text = eregi_replace('\[\[phone_login\]\]',         $phone_login,         $et_text);
    $et_text = eregi_replace('\[\[group\]\]',               $group,               $et_text);
    $et_text = eregi_replace('\[\[channel_group\]\]',       $channel_group,       $et_text);
    $et_text = eregi_replace('\[\[SQLdate\]\]',             $SQLdate,             $et_text);
    $et_text = eregi_replace('\[\[epoch\]\]',               $epoch,               $et_text);
    $et_text = eregi_replace('\[\[uniqueid\]\]',            $uniqueid,            $et_text);
    $et_text = eregi_replace('\[\[customer_zap_channel\]\]',$customer_zap_channel,$et_text);
    $et_text = eregi_replace('\[\[server_ip\]\]',           $server_ip,           $et_text);
    $et_text = eregi_replace('\[\[SIPexten\]\]',            $SIPexten,            $et_text);
    $et_text = eregi_replace('\[\[session_id\]\]',          $session_id,          $et_text);

    $et_text = eregi_replace('\[\[title\]\]',               $title,               $et_text);
    $et_text = eregi_replace('\[\[first_name\]\]',          $first_name,          $et_text);
    $et_text = eregi_replace('\[\[middle_initial\]\]',      $middle_initial,      $et_text);
    $et_text = eregi_replace('\[\[last_name\]\]',           $last_name,           $et_text);
    $et_text = eregi_replace('\[\[address1\]\]',            $address1,            $et_text);
    $et_text = eregi_replace('\[\[address2\]\]',            $address2,            $et_text);
    $et_text = eregi_replace('\[\[address3\]\]',            $address3,            $et_text);
    $et_text = eregi_replace('\[\[city\]\]',                $city,                $et_text);
    $et_text = eregi_replace('\[\[state\]\]',               $state,               $et_text);
    $et_text = eregi_replace('\[\[province\]\]',            $province,            $et_text);
    $et_text = eregi_replace('\[\[postal_code\]\]',         $postal_code,         $et_text);
    $et_text = eregi_replace('\[\[country_code\]\]',        $country_code,        $et_text);
    $et_text = eregi_replace('\[\[phone_code\]\]',          $phone_code,          $et_text);
    $et_text = eregi_replace('\[\[phone_number\]\]',        $phone_number,        $et_text);
    $et_text = eregi_replace('\[\[alt_phone\]\]',           $alt_phone,           $et_text);
    $et_text = eregi_replace('\[\[email\]\]',               $email,               $et_text);
    $et_text = eregi_replace('\[\[gender\]\]',              $gender,              $et_text);
    $et_text = eregi_replace('\[\[date_of_birth\]\]',       $date_of_birth,       $et_text);
    $et_text = eregi_replace('\[\[post_date\]\]',           $post_date,           $et_text);
    $et_text = eregi_replace('\[\[vendor_lead_code\]\]',    $vendor_lead_code,    $et_text);
    $et_text = eregi_replace('\[\[comments\]\]',            $comments,            $et_text);
    $et_text = eregi_replace('\[\[custom1\]\]',             $custom1,             $et_text);
    $et_text = eregi_replace('\[\[custom2\]\]',             $custom2,             $et_text);
    ...
    if ($LOG['modify_scripts']==1) {
        ...
        if (strlen($et_id) < 2 or strlen($et_name) < 2 or strlen($et_body_html) < 2) {
            ...
            if ($email) {
                ...
                $et_subject   = eregi_replace('\[\[list_id\]\]',             $list_id,             $et_subject);
                $et_subject   = eregi_replace('\[\[gmt_offset_now\]\]',      $gmt_offset_now,      $et_subject);
                $et_subject   = eregi_replace('\[\[fullname\]\]',            $fullname,            $et_subject);
                $et_subject   = eregi_replace('\[\[fronter\]\]',             $fronter,             $et_subject);
                $et_subject   = eregi_replace('\[\[user\]\]',                $user,                $et_subject);
                $et_subject   = eregi_replace('\[\[pass\]\]',                $pass,                $et_subject);
                $et_subject   = eregi_replace('\[\[lead_id\]\]',             $lead_id,             $et_subject);
                $et_subject   = eregi_replace('\[\[campaign\]\]',            $campaign,            $et_subject);
                $et_subject   = eregi_replace('\[\[phone_login\]\]',         $phone_login,         $et_subject);
                $et_subject   = eregi_replace('\[\[group\]\]',               $group,               $et_subject);
                $et_subject   = eregi_replace('\[\[channel_group\]\]',       $channel_group,       $et_subject);
                $et_subject   = eregi_replace('\[\[SQLdate\]\]',             $SQLdate,             $et_subject);
                $et_subject   = eregi_replace('\[\[epoch\]\]',               $epoch,               $et_subject);
                $et_subject   = eregi_replace('\[\[uniqueid\]\]',            $uniqueid,            $et_subject);
                $et_subject   = eregi_replace('\[\[customer_zap_channel\]\]',$customer_zap_channel,$et_subject);
                $et_subject   = eregi_replace('\[\[server_ip\]\]',           $server_ip,           $et_subject);
                $et_subject   = eregi_replace('\[\[SIPexten\]\]',            $SIPexten,            $et_subject);
                $et_subject   = eregi_replace('\[\[session_id\]\]',          $session_id,          $et_subject);
                $et_subject   = eregi_replace('\[\[title\]\]',               $title,               $et_subject);
                $et_subject   = eregi_replace('\[\[first_name\]\]',          $first_name,          $et_subject);
                $et_subject   = eregi_replace('\[\[middle_initial\]\]',      $middle_initial,      $et_subject);
                $et_subject   = eregi_replace('\[\[last_name\]\]',           $last_name,           $et_subject);
                $et_subject   = eregi_replace('\[\[address1\]\]',            $address1,            $et_subject);
                $et_subject   = eregi_replace('\[\[address2\]\]',            $address2,            $et_subject);
                $et_subject   = eregi_replace('\[\[address3\]\]',            $address3,            $et_subject);
                $et_subject   = eregi_replace('\[\[city\]\]',                $city,                $et_subject);
                $et_subject   = eregi_replace('\[\[state\]\]',               $state,               $et_subject);
                $et_subject   = eregi_replace('\[\[province\]\]',            $province,            $et_subject);
                $et_subject   = eregi_replace('\[\[postal_code\]\]',         $postal_code,         $et_subject);
                $et_subject   = eregi_replace('\[\[country_code\]\]',        $country_code,        $et_subject);
                $et_subject   = eregi_replace('\[\[phone_code\]\]',          $phone_code,          $et_subject);
                $et_subject   = eregi_replace('\[\[phone_number\]\]',        $phone_number,        $et_subject);
                $et_subject   = eregi_replace('\[\[alt_phone\]\]',           $alt_phone,           $et_subject);
                $et_subject   = eregi_replace('\[\[email\]\]',               $email,               $et_subject);
                $et_subject   = eregi_replace('\[\[gender\]\]',              $gender,              $et_subject);
                $et_subject   = eregi_replace('\[\[date_of_birth\]\]',       $date_of_birth,       $et_subject);
                $et_subject   = eregi_replace('\[\[post_date\]\]',           $post_date,           $et_subject);
                $et_subject   = eregi_replace('\[\[vendor_lead_code\]\]',    $vendor_lead_code,    $et_subject);
                $et_subject   = eregi_replace('\[\[comments\]\]',            $comments,            $et_subject);
                $et_subject   = eregi_replace('\[\[custom1\]\]',             $custom1,             $et_subject);
                $et_subject   = eregi_replace('\[\[custom2\]\]',             $custom2,             $et_subject);

                $et_body_html = eregi_replace('\[\[list_id\]\]',             $list_id,             $et_body_html);
                $et_body_html = eregi_replace('\[\[gmt_offset_now\]\]',      $gmt_offset_now,      $et_body_html);
                $et_body_html = eregi_replace('\[\[fullname\]\]',            $fullname,            $et_body_html);
                $et_body_html = eregi_replace('\[\[fronter\]\]',             $fronter,             $et_body_html);
                $et_body_html = eregi_replace('\[\[user\]\]',                $user,                $et_body_html);
                $et_body_html = eregi_replace('\[\[pass\]\]',                $pass,                $et_body_html);
                $et_body_html = eregi_replace('\[\[lead_id\]\]',             $lead_id,             $et_body_html);
                $et_body_html = eregi_replace('\[\[campaign\]\]',            $campaign,            $et_body_html);
                $et_body_html = eregi_replace('\[\[phone_login\]\]',         $phone_login,         $et_body_html);
                $et_body_html = eregi_replace('\[\[group\]\]',               $group,               $et_body_html);
                $et_body_html = eregi_replace('\[\[channel_group\]\]',       $channel_group,       $et_body_html);
                $et_body_html = eregi_replace('\[\[SQLdate\]\]',             $SQLdate,             $et_body_html);
                $et_body_html = eregi_replace('\[\[epoch\]\]',               $epoch,               $et_body_html);
                $et_body_html = eregi_replace('\[\[uniqueid\]\]',            $uniqueid,            $et_body_html);
                $et_body_html = eregi_replace('\[\[customer_zap_channel\]\]',$customer_zap_channel,$et_body_html);
                $et_body_html = eregi_replace('\[\[server_ip\]\]',           $server_ip,           $et_body_html);
                $et_body_html = eregi_replace('\[\[SIPexten\]\]',            $SIPexten,            $et_body_html);
                $et_body_html = eregi_replace('\[\[session_id\]\]',          $session_id,          $et_body_html);
                $et_body_html = eregi_replace('\[\[title\]\]',               $title,               $et_body_html);
                $et_body_html = eregi_replace('\[\[first_name\]\]',          $first_name,          $et_body_html);
                $et_body_html = eregi_replace('\[\[middle_initial\]\]',      $middle_initial,      $et_body_html);
                $et_body_html = eregi_replace('\[\[last_name\]\]',           $last_name,           $et_body_html);
                $et_body_html = eregi_replace('\[\[address1\]\]',            $address1,            $et_body_html);
                $et_body_html = eregi_replace('\[\[address2\]\]',            $address2,            $et_body_html);
                $et_body_html = eregi_replace('\[\[address3\]\]',            $address3,            $et_body_html);
                $et_body_html = eregi_replace('\[\[city\]\]',                $city,                $et_body_html);
                $et_body_html = eregi_replace('\[\[state\]\]',               $state,               $et_body_html);
                $et_body_html = eregi_replace('\[\[province\]\]',            $province,            $et_body_html);
                $et_body_html = eregi_replace('\[\[postal_code\]\]',         $postal_code,         $et_body_html);
                $et_body_html = eregi_replace('\[\[country_code\]\]',        $country_code,        $et_body_html);
                $et_body_html = eregi_replace('\[\[phone_code\]\]',          $phone_code,          $et_body_html);
                $et_body_html = eregi_replace('\[\[phone_number\]\]',        $phone_number,        $et_body_html);
                $et_body_html = eregi_replace('\[\[alt_phone\]\]',           $alt_phone,           $et_body_html);
                $et_body_html = eregi_replace('\[\[email\]\]',               $email,               $et_body_html);
                $et_body_html = eregi_replace('\[\[gender\]\]',              $gender,              $et_body_html);
                $et_body_html = eregi_replace('\[\[date_of_birth\]\]',       $date_of_birth,       $et_body_html);
                $et_body_html = eregi_replace('\[\[post_date\]\]',           $post_date,           $et_body_html);
                $et_body_html = eregi_replace('\[\[vendor_lead_code\]\]',    $vendor_lead_code,    $et_body_html);
                $et_body_html = eregi_replace('\[\[comments\]\]',            $comments,            $et_body_html);
                $et_body_html = eregi_replace('\[\[custom1\]\]',             $custom1,             $et_body_html);
                $et_body_html = eregi_replace('\[\[custom2\]\]',             $custom2,             $et_body_html);

                $et_body_text = eregi_replace('\[\[list_id\]\]',             $list_id,             $et_body_text);
                $et_body_text = eregi_replace('\[\[gmt_offset_now\]\]',      $gmt_offset_now,      $et_body_text);
                $et_body_text = eregi_replace('\[\[fullname\]\]',            $fullname,            $et_body_text);
                $et_body_text = eregi_replace('\[\[fronter\]\]',             $fronter,             $et_body_text);
                $et_body_text = eregi_replace('\[\[user\]\]',                $user,                $et_body_text);
                $et_body_text = eregi_replace('\[\[pass\]\]',                $pass,                $et_body_text);
                $et_body_text = eregi_replace('\[\[lead_id\]\]',             $lead_id,             $et_body_text);
                $et_body_text = eregi_replace('\[\[campaign\]\]',            $campaign,            $et_body_text);
                $et_body_text = eregi_replace('\[\[phone_login\]\]',         $phone_login,         $et_body_text);
                $et_body_text = eregi_replace('\[\[group\]\]',               $group,               $et_body_text);
                $et_body_text = eregi_replace('\[\[channel_group\]\]',       $channel_group,       $et_body_text);
                $et_body_text = eregi_replace('\[\[SQLdate\]\]',             $SQLdate,             $et_body_text);
                $et_body_text = eregi_replace('\[\[epoch\]\]',               $epoch,               $et_body_text);
                $et_body_text = eregi_replace('\[\[uniqueid\]\]',            $uniqueid,            $et_body_text);
                $et_body_text = eregi_replace('\[\[customer_zap_channel\]\]',$customer_zap_channel,$et_body_text);
                $et_body_text = eregi_replace('\[\[server_ip\]\]',           $server_ip,           $et_body_text);
                $et_body_text = eregi_replace('\[\[SIPexten\]\]',            $SIPexten,            $et_body_text);
                $et_body_text = eregi_replace('\[\[session_id\]\]',          $session_id,          $et_body_text);
                $et_body_text = eregi_replace('\[\[title\]\]',               $title,               $et_body_text);
                $et_body_text = eregi_replace('\[\[first_name\]\]',          $first_name,          $et_body_text);
                $et_body_text = eregi_replace('\[\[middle_initial\]\]',      $middle_initial,      $et_body_text);
                $et_body_text = eregi_replace('\[\[last_name\]\]',           $last_name,           $et_body_text);
                $et_body_text = eregi_replace('\[\[address1\]\]',            $address1,            $et_body_text);
                $et_body_text = eregi_replace('\[\[address2\]\]',            $address2,            $et_body_text);
                $et_body_text = eregi_replace('\[\[address3\]\]',            $address3,            $et_body_text);
                $et_body_text = eregi_replace('\[\[city\]\]',                $city,                $et_body_text);
                $et_body_text = eregi_replace('\[\[state\]\]',               $state,               $et_body_text);
                $et_body_text = eregi_replace('\[\[province\]\]',            $province,            $et_body_text);
                $et_body_text = eregi_replace('\[\[postal_code\]\]',         $postal_code,         $et_body_text);
                $et_body_text = eregi_replace('\[\[country_code\]\]',        $country_code,        $et_body_text);
                $et_body_text = eregi_replace('\[\[phone_code\]\]',          $phone_code,          $et_body_text);
                $et_body_text = eregi_replace('\[\[phone_number\]\]',        $phone_number,        $et_body_text);
                $et_body_text = eregi_replace('\[\[alt_phone\]\]',           $alt_phone,           $et_body_text);
                $et_body_text = eregi_replace('\[\[email\]\]',               $email,               $et_body_text);
                $et_body_text = eregi_replace('\[\[gender\]\]',              $gender,              $et_body_text);
                $et_body_text = eregi_replace('\[\[date_of_birth\]\]',       $date_of_birth,       $et_body_text);
                $et_body_text = eregi_replace('\[\[post_date\]\]',           $post_date,           $et_body_text);
                $et_body_text = eregi_replace('\[\[vendor_lead_code\]\]',    $vendor_lead_code,    $et_body_text);
                $et_body_text = eregi_replace('\[\[comments\]\]',            $comments,            $et_body_text);
                $et_body_text = eregi_replace('\[\[custom1\]\]',             $custom1,             $et_body_text);
                $et_body_text = eregi_replace('\[\[custom2\]\]',             $custom2,             $et_body_text);
