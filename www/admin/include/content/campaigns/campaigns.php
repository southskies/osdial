...
if ($ADD==31)
{
	...
	if ($SUB < 1)
		...
		echo "<tr bgcolor=$oddrows><td align=right>Campaign OSDial exten: </td><td align=left><input type=text name=campaign_vdad_exten size=10 maxlength=20 value=\"$campaign_vdad_exten\">$NWB#osdial_campaigns-campaign_vdad_exten$NWE</td></tr>\n";
