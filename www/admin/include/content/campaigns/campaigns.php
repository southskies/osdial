...
if ($ADD==11)
{
	...
	echo "<tr bgcolor=#C1D6DF><td align=right>Campaign Call Time: </td><td align=left><select size=1 name=campaign_call_time>";
	...
	echo "<tr bgcolor=#C1D6DF><td align=right>Allow Tab Switch: </td><td align=left><select size=1 name=allow_tab_switch><option selected>Y</option><option>N</option></select>$NWB#osdial_campaigns-allow_tab_switch$NWE</td></tr>\n";
...
if ($ADD==31)
{
	...
	if ($SUB < 1)
		...
		echo "<tr bgcolor=#C1D6DF><td align=right>Web Form 1 External: </td><td align=left><select size=1 name=web_form_extwindow><option>Y</option><option>N</option><option SELECTED>$web_form_extwindow</option></select><font size=1><i>'Y' to open in new window, 'N' to open in an OSDial frame.</i></font>$NWB#osdial_campaigns-web_form_extwindow$NWE</td></tr>\n";
		...
		echo "<tr bgcolor=#C1D6DF><td align=right>Web Form 2 External: </td><td align=left><select size=1 name=web_form2_extwindow><option>Y</option><option>N</option><option SELECTED>$web_form2_extwindow</option></select><font size=1><i>'Y' to open in new window, 'N' to open in an OSDial frame.</i></font>$NWB#osdial_campaigns-web_form_extwindow$NWE</td></tr>\n";
		...
		echo "<tr bgcolor=#C1D6DF><td align=right><a href=\"$PHP_SELF?ADD=311111111&call_time_id=$campaign_call_time\">Campaign Call Time: </a></td><td align=left><select size=1 name=campaign_call_time>\n";
		...
		echo "<tr bgcolor=#C1D6DF><td align=right>Preview Force Dial Time: </td><td align=left><input type=text name=preview_force_dial_time size=3 maxlength=3 value=\"$preview_force_dial_time\"> <i>in seconds, 0 disables</i>$NWB#osdial_campaigns-preview_force_dial_time$NWE</td></tr>\n";

		echo "<tr bgcolor=#C1D6DF><td align=right>Manual Preview Default: </td><td align=left><select size=1 name=manual_preview_default><option>Y</option><option>N</option><option selected>$manual_preview_default</option></select>$NWB#osdial_campaigns-manual_preview_default$NWE</td></tr>\n";
	    ...
	    echo "<tr bgcolor=#C1D6DF><td align=right>Answers Per Hour Limit: </td><td align=left><input type=text name=answers_per_hour_limit size=10 maxlength=10 value=\"$answers_per_hour_limit\">$NWB#osdial_campaigns-answers_per_hour_limit$NWE</td></tr>\n";
