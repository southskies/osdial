...
# 090515-0129 - Added manual_force_dial_time, fixed some minor errors on save.
...
if ($ADD==31)
{
	...
	if ($SUB < 1)
		...
		echo "<tr bgcolor=#C1D6DF><td align=right>Preview Force Dial Time: </td><td align=left><input type=text name=manual_force_dial_time size=3 maxlength=3 value=\"$manual_force_dial_time\"> <i>in seconds, 0 disables</i>$NWB#osdial_campaigns-manual_force_dial_time$NWE</td></tr>\n";

		echo "<tr bgcolor=#C1D6DF><td align=right>Preview Dial Default: </td><td align=left><select size=1 name=manual_preview_default><option>Y</option><option>N</option><option selected>$manual_preview_default</option></select>$NWB#osdial_campaigns-manual_preview_default$NWE</td></tr>\n";
