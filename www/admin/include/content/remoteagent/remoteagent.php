...
if ($ADD==11111)
{
	...
	echo "<tr bgcolor=$oddrows><td align=right width=35%>Agent ID Start: </td><td align=left><input type=text name=user_start size=6 maxlength=20> (numbers only, incremented)$NWB#osdial_remote_agents-user_start$NWE</td></tr>\n";
...
if ($ADD==31111)
{
	...
	echo "<TABLE width=$section_width cellspacing=3>\n";
	echo "<tr bgcolor=$oddrows><td align=right width=35%>Agent ID Start: </td><td align=left><input type=text name=user_start size=7 maxlength=6 value=\"$user_start\"> (numbers only, incremented)$NWB#osdial_remote_agents-user_start$NWE</td></tr>\n";
