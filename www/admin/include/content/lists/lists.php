...
echo "<center><br><font color=navy size=+1>LOAD NEW LEADS</font>
	<form action=$PHP_SELF method=POST><br><br>\n";
echo "<input type='hidden' name='ADD' value='122'>\n";
...
<tr>
	...
	<td align=center colspan=2><input type=submit value="SUBMIT" name='submit_file'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button onClick="javascript:document.location='admin.php'" value="START OVER" name='reload_page'></td>
  </tr>
</table>
<? } ?>
...
if ($leadfile) {
	...
	if (!eregi(".csv", $leadfile_name) && !eregi(".xls", $leadfile_name)) {
		...
		if ($WeBRooTWritablE > 0)
			{
			copy($LF_path, "$WeBServeRRooT/vicidial/osdial_temp_file.txt");
		...
		print "<script language='JavaScript1.2'>document.forms[0].leadfile.disabled=false; document.forms[0].submit_file.disabled=false; document.forms[0].reload_page.disabled=false;</script>";
			...
			if (!eregi(".csv", $leadfile_name) && !eregi(".xls", $leadfile_name)) 
				...
				if ($WeBRooTWritablE > 0)
					{
					copy($LF_path, "$WeBServeRRooT/vicidial/osdial_temp_file.txt");
					$lead_file = "$WeBServeRRooT/vicidial/osdial_temp_file.txt";
					}
				else
					{
					copy($LF_path, "/tmp/osdial_temp_file.txt");
			...
			else if (!eregi(".csv", $leadfile_name)) 
			{
				if ($WeBRooTWritablE > 0)
					{
					copy($LF_path, "$WeBServeRRooT/vicidial/osdial_temp_file.xls");
					$lead_file = "$WeBServeRRooT/vicidial/osdial_temp_file.xls";
					}
				else
					{
			...
			else 
			{
				if ($WeBRooTWritablE > 0)
					{
					copy($LF_path, "$WeBServeRRooT/vicidial/osdial_temp_file.csv");
					$lead_file = "$WeBServeRRooT/vicidial/osdial_temp_file.csv";
					}
				else
					{
			...
			print "    <th colspan=2><input type=submit name='OK_to_process' value='OK TO PROCESS'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button onClick=\"javascript:document.location='admin.php?122'\" value=\"START OVER\" name='reload_page'></th>\r\n";
			print "  </tr>\r\n";
			print "</table>\r\n";
	# }
		print "<script language='JavaScript1.2'>document.forms[0].leadfile.disabled=false; document.forms[0].submit_file.disabled=false; document.forms[0].reload_page.disabled=false;</script>";
