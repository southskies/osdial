...
if ($ADD==999999 && ($SUB==11 || $SUB==12 || $SUB==13 || $SUB==14)) {
	...
	if ($SUB==12 || $SUB==14) {
		...
		$metadetail .= "&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&cpuinfo=$cpuinfo";
	}
    ...
    <tr class='no-ul' bgcolor=<?= $subcamp_color ?>>
        <td height=20 align=left colspan=10>
            <font face="arial,helvetica" color=<?=$default_text?> size=<?= $subcamp_font_size ?>> &nbsp; 
                ...
                <a href="<?= $PHP_SELF ?>?ADD=999999&SUB=13"> Real-Time Campaigns Summary </a>
            </font>
        </td>
    </tr>
    <?
