...
$server_domainname = get_variable("server_domainname");
$server_public_ip = get_variable("server_public_ip");
...
$system_email = get_variable("system_email");
