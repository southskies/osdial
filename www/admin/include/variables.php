    ...
    foreach ($tzids as $tzid) {
        if (preg_match('/'.$tzmatch.'/',$tzid)) {
            ...
            if (!empty($tzsn)) { 
                ...
                if (!isset($tzalt[$tzdsn])) $tzalt[$tzdsn] = $tzsn;
                if (!isset($tzaltDST[$tzsn])) $tzaltDST[$tzsn] = $tzdsn;
...
$tzt = $tzalt;
foreach ($tzaltDST as $k => $v) {
    if (!isset($tzalt[$k])) $tzalt[$k] = $k;
}
foreach ($tzt as $k => $v) {
    if (!isset($tzaltDST[$k])) $tzaltDST[$k] = $k;
}
ksort($tzrefid);
ksort($tzrefidDST);
ksort($tzalt);
...
$acct_method = get_variable("acct_method");
$acct_startdate = get_variable("acct_startdate");
$acct_enddate = get_variable("acct_enddate");
$acct_cutoff = get_variable("acct_cutoff");
$acct_expire_days = get_variable("acct_expire_days");
$acct_email_warning_time = get_variable("acct_email_warning_time");
$acct_email_warning_expire = get_variable("acct_email_warning_expire");
$acct_email_warning_message = get_variable("acct_email_warning_message");
$acct_email_warning_from = get_variable("acct_email_warning_from");
$acct_email_warning_subject = get_variable("acct_email_warning_subject");
...
$admin_session_expiration = get_variable("admin_session_expiration");
$admin_session_lockout = get_variable("admin_session_lockout");
...
$asterisk_languages = get_variable("asterisk_languages");
...
$contact_name = get_variable("contact_name");
$contact_phone_number = get_variable("contact_phone_number");
$contact_address = get_variable("contact_address");
$contact_address2 = get_variable("contact_address2");
$contact_city = get_variable("contact_city");
$contact_state = get_variable("contact_state");
$contact_postal_code = get_variable("contact_postal_code");
$contact_country = get_variable("contact_country");
...
$dialplan = get_variable("dialplan");
...
$exten_id = get_variable("exten_id");
$edata_id = get_variable("edata_id");
$ext_type = get_variable("ext_type");
$ext_context = get_variable("ext_context");
$ext_priority = get_variable("ext_priority");
$ext_app = get_variable("ext_app");
$ext_appdata = get_variable("ext_appdata");
$ext_selectable = get_variable("ext_selectable");
$ext_readonly = get_variable("ext_readonly");
...
$last_general_extension = get_variable("last_general_extension");
...
$lead_order_direction = get_variable("lead_order_direction");
$lead_order_field = get_variable("lead_order_field");
$lead_order_nthnew = get_variable("lead_order_nthnew");
...
$old_company = get_variable("old_company");
...
$organization_field = get_variable("organization_field");
$organization_title = get_variable("organization_title");
$organization_title_field = get_variable("organization_title_field");
...
$other_action = get_variable("other_action");
$other_newcomp_acct_method = get_variable("other_newcomp_acct_method");
$other_newcomp_initial_units = get_variable("other_newcomp_initial_units");
...
$IVR = get_variable("IVR");
$ivr_id = get_variable("ivr_id");
...
$purchase_type = get_variable("purchase_type");
$purchase_quantity = get_variable("purchase_quantity");
$purchase_val = get_variable("purchase_val");
$purchase_expire_date = get_variable("purchase_expire_date");
$payment_method = get_variable("payment_method");
$payment_type = get_variable("payment_type");
$payment_amount = get_variable("payment_amount");
$payment_transid = get_variable("payment_transid");
$payment_date = get_variable("payment_date");
$payment_details = get_variable("payment_details");
...
$prompt_language = get_variable("prompt_language");
...
$recurring = get_variable("recurring");
$recurring_days = get_variable("recurring_days");
$readonly = get_variable("readonly");
$RR = get_variable("RR");
...
$use_browser_timezone_offset = get_variable("use_browser_timezone_offset");
