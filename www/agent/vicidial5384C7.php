...
echo "<BR><BR><BR><CENTER><TABLE frame=border WIDTH=460 CELLPADDING=0 CELLSPACING=0 BGCOLOR=#5384C7><TR BGCOLOR=#5384C7>"; //#E0C2D6
echo "<TD ALIGN=LEFT VALIGN=BOTTOM><b>&nbsp;&nbsp;<font color=white>VICIDIAL</b><!-- IMG SRC=\"./images/vdc_tab_vicidial.gif\" BORDER=0--></TD>";
echo "<TD ALIGN=left><font color=white><b>Agent Login</b></TD>";
echo "</TR>\n";
...
if ($user_login_first == 1)
{
	...
	echo "<TABLE WIDTH=460 CELLPADDING=0 CELLSPACING=0 BGCOLOR=#5384C7><TR BGCOLOR=#5384C7>";
	echo "<TD ALIGN=LEFT VALIGN=BOTTOM><b>&nbsp;&nbsp;<font color=white>VICIDIAL</b><!--IMG SRC=\"./images/vdc_tab_vicidial.gif\" BORDER=0 --></TD>";
	...
	else
	{
		...
		echo "<FORM  NAME=vicidial_form ID=vicidial_form ACTION=\"$agcPAGE\" METHOD=POST>\n";
		echo "<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
		echo "<BR><BR><BR><CENTER><TABLE WIDTH=460 CELLPADDING=0 CELLSPACING=0 BGCOLOR=#5384C7><TR BGCOLOR=#5384C7>";
		echo "<TD ALIGN=LEFT VALIGN=BOTTOM><b>&nbsp;&nbsp;VICIDIAL</b><!--IMG SRC=\"./images/vdc_tab_vicidial.gif\" BORDER=0--></TD>";
...
echo "<BR><BR><BR><CENTER><TABLE WIDTH=460 CELLPADDING=0 CELLSPACING=0 BGCOLOR=#5384C7><TR BGCOLOR=#5384C7>";
echo "<TD ALIGN=LEFT VALIGN=BOTTOM><b>&nbsp;&nbsp;<font color=white>VICIDIAL</b><!--IMG SRC=\"./images/vdc_tab_vicidial.gif\" BORDER=0--></TD>";
echo "<TD ALIGN=left VALIGN=MIDDLE> <font color=white><b>Phone Login</b></TD>";
echo "</TR>\n";
echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1> &nbsp; </TD></TR>\n";
echo "<TR><TD ALIGN=RIGHT><font color=white>Phone Login: </TD>";
...
$VDloginDISPLAY=0;
	...
	echo "<TABLE WIDTH=460 CELLPADDING=0 CELLSPACING=0 BGCOLOR=#5384C7><TR BGCOLOR=#5384C7>";
	echo "<TD ALIGN=LEFT VALIGN=BOTTOM><br>&nbsp;&nbsp;<font color=white>VICIDIAL</b><!--IMG SRC=\"./images/vdc_tab_vicidial.gif\" BORDER=0--></TD>";
	echo "<TD ALIGN=left VALIGN=MIDDLE> <font color=white><b>Campaign Login</b> </TD>";
	echo "</TR>\n";
	echo "<TR><TD ALIGN=LEFT COLSPAN=2><font size=1> &nbsp; </TD></TR>\n";
	echo "<TR><TD ALIGN=RIGHT><font color=white>User Login:  </TD>";
	echo "<TD ALIGN=LEFT><INPUT TYPE=TEXT NAME=VD_login SIZE=10 MAXLENGTH=20 VALUE=\"$VD_login\"></TD></TR>\n";
...
?>
	...
	var panel_bgcolor = '#5384C7'; //#E0C2D6
					...
					//	alert(xmlhttprequestcheckconf.responseText);
						...
						if ( (conf_channels_xtra_display == 1) || (conf_channels_xtra_display == 0) )
							...
							if (live_conf_calls > 0)
								...
								var conv_start=-1;
								var live_conf_HTML = "<font face=\"Arial,Helvetica\"><B>LIVE CALLS IN YOUR SESSION:</B></font><BR><TABLE WIDTH=<?=$SDwidth ?>><TR BGCOLOR=#5384C7><TD><font class=\"log_title\">#</TD><TD><font class=\"log_title\">REMOTE CHANNEL</TD><TD><font class=\"log_title\">HANGUP</TD><TD><font class=\"log_title\">VOLUME</TD></TR>";
...
// Check to see if there is a call being sent from the auto-dialer to agent conf
	function RepullLeadData(lookup) {
		if (typeof(xmlhttprequestrepull) == "undefined") {
			var oldlead = document.vicidial_form.lead_id.value;
			var oldphone = document.vicidial_form.phone_number.value;
			var curuniqueid = document.vicidial_form.uniqueid.value;
			var list_id = document.vicidial_form.list_id.value;
			...
			if (xmlhttprequestrepull) {
				...
				xmlhttprequestrepull.onreadystatechange = function() { 
					...
					//		alert(xmlhttprequestrepull.responseText);
							...
							RPLD_web_form_address = VICIDiaL_web_form_address;

							document.vicidial_form.lead_id.value		= check_RPLD_array[0];
							document.vicidial_form.vendor_lead_code.value	= check_RPLD_array[1];
							document.vicidial_form.list_id.value		= check_RPLD_array[2];
							document.vicidial_form.gmt_offset_now.value	= check_RPLD_array[3];
							document.vicidial_form.phone_code.value		= check_RPLD_array[4];
							document.vicidial_form.phone_number.value	= check_RPLD_array[5];
							document.vicidial_form.title.value		= check_RPLD_array[6];
							document.vicidial_form.first_name.value		= check_RPLD_array[7];
							document.vicidial_form.middle_initial.value	= check_RPLD_array[8];
							document.vicidial_form.last_name.value		= check_RPLD_array[9];
							document.vicidial_form.address1.value		= check_RPLD_array[10];
							document.vicidial_form.address2.value		= check_RPLD_array[11];
							document.vicidial_form.address3.value		= check_RPLD_array[12];
							document.vicidial_form.city.value		= check_RPLD_array[13];
							document.vicidial_form.state.value		= check_RPLD_array[14];
							document.vicidial_form.province.value		= check_RPLD_array[15];
							document.vicidial_form.postal_code.value	= check_RPLD_array[16];
							document.vicidial_form.country_code.value	= check_RPLD_array[17];
							document.vicidial_form.gender.value		= check_RPLD_array[18];
							document.vicidial_form.date_of_birth.value	= check_RPLD_array[19];
							document.vicidial_form.alt_phone.value		= check_RPLD_array[20];
							document.vicidial_form.email.value		= check_RPLD_array[21];
							document.vicidial_form.security_phrase.value	= check_RPLD_array[22];

							var REGcommentsNL = new RegExp("!N","g");
							check_RPLD_array[23] = check_RPLD_array[23].replace(REGcommentsNL, "\n");
							document.vicidial_form.comments.value		= check_RPLD_array[23];

							document.vicidial_form.called_count.value	= check_RPLD_array[24];
							...
							document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + RPLD_web_form_address + web_form_vars + "\" target=\"vdcwebform\" onMouseOver=\"WebFormRefresH();\"><IMG SRC=\"./images/vdc_LB_webform.gif\" border=0 alt=\"Web Form\"></a>\n";
...
// Generate the Call Disposition Chooser panel
	function DispoSelectContent_create(taskDSgrp,taskDSstage)
		...
		var dispo_HTML = "<br><table frame=border cellpadding=5 cellspacing=5 width=500><tr><td colspan=2 align=center><B><font color=white>CALL DISPOSITION</B></td></tr><tr><td bgcolor=\"#99FF99\" height=300 width=240 valign=top><font class=\"log_text\"><span id=DispoSelectA>";
		var loop_ct = 0;
...
// Generate the Pause Code Chooser panel
	function PauseCodeSelectContent_create()
		...
		if ( (AutoDialWaiting == 1) || (VD_live_customer_call==1) || (alt_dial_active==1) )
			...
			PauseCode_HTML = "<table frame=border cellpadding=5 cellspacing=5 width=500><tr><td colspan=2><B> PAUSE CODE</B></td></tr><tr><td bgcolor=\"#99FF99\" height=300 width=240 valign=top><font class=\"log_text\"><span id=PauseCodeSelectA>";
			var loop_ct = 0;
	...
	function LogouT()
		...
		if (MD_channel_look==1)
			...
			if (VD_live_customer_call==1)
				...
				document.getElementById("LogouTBoxLink").innerHTML = "<a href=\"" + agcPAGE + "?relogin=YES&session_epoch=" + epoch_sec + "&session_id=" + session_id + "&session_name=" + session_name + "&VD_login=" + user + "&VD_campaign=" + campaign + "&phone_login=" + phone_login + "&phone_pass=" + phone_pass + "&VD_pass=" + pass + "\">LOG IN AGAIN</a>\n";
...
// GLOBAL FUNCTIONS
	...
	function MainPanelToFront(resumevar)
		{
		document.getElementById("MainTable").style.backgroundColor="#5384C7"; //#E0C2D6
		document.getElementById("MaiNfooter").style.backgroundColor="#5384C7";
		hideDiv('ScriptPanel');
		showDiv('MainPanel');
		if (resumevar != 'NO')
			{
	...
	function ScriptPanelToFront()
		{
		showDiv('ScriptPanel');
		document.getElementById("MainTable").style.backgroundColor="#5384C7";
		document.getElementById("MaiNfooter").style.backgroundColor="#5384C7";
		panel_bgcolor='#5384C7';
		document.getElementById("MainStatuSSpan").style.background = panel_bgcolor;
		}
	...
	function ChooseForm(img, old_src, new_src) {
		var cur_file = img.src.substring(img.src.lastIndexOf("/")+1);
		var old_file = old_src.substring(old_src.lastIndexOf("/")+1);
		var new_file = new_src.substring(new_src.lastIndexOf("/")+1);
...
<!--
   ...
   .a:link {color: blue} a:visited {color: navy} a:active {color: navy}
-->
</style>
<?
echo "</head>\n";
...
<TABLE CELLPADDING=0 CELLSPACING=0 BGCOLOR=white WIDTH=<?=$MNwidth ?> MARGINWIDTH=0 MARGINHEIGHT=0 LEFTMARGIN=0 TOPMARGIN=0 VALIGN=TOP ALIGN=LEFT> <!-- FIRST LINE -->
<TR VALIGN=TOP ALIGN=LEFT><TD COLSPAN=3 VALIGN=TOP ALIGN=LEFT>
<INPUT TYPE=HIDDEN NAME=extension>
<font class="body_text">
<?	echo "<font color=navy>&nbsp;Logged in as User: $VD_login on Phone: $SIP_user to campaign: $VD_campaign&nbsp; </font>\n"; ?>
...
<span style="position:absolute;left:0px;top:13px;z-index:1;" id="Tabs">
    <table bgcolor=white width=<?=$MNwidth ?> height=30> <!-- 2nd line -->
<TR VALIGN=TOP ALIGN=LEFT>

<td colspan=2><!--img onclick="ChangeImage(this, './images/vdc_tab_buttons2.gif');" src="./images/vdc_tab_buttons1.gif" border="0" width="223" height="30"-->
<img onclick="ChooseForm(this, 'images/vdc_tab_buttons1.gif', 'images/vdc_tab_buttons2.gif');" src="images/vdc_tab_buttons1.gif" border="0" width="223" height="30">
</td>
...
<TD WIDTH=<?=$HSwidth ?> VALIGN=MIDDLE ALIGN=CENTER><font class="body_text"> &nbsp; <span id=status>LIVE</span> &nbsp; &nbsp; <font color=navy>Session ID: <span id=sessionIDspan></span> &nbsp; &nbsp; <span id=AgentStatusCalls></span></TD>
...
<span style="position:absolute;left:0px;top:0px;z-index:3;" id="WelcomeBoxA">
    <table border=0 bgcolor="#FFFFFF" width=<?=$CAwidth ?> height=<?=$HKwidth ?>><TR><TD align=center><BR><span id="WelcomeBoxAt"><font color=white>VICIDIAL</font></span></TD></TR></TABLE>
</span>
...
<span style="position:absolute;left:0px;top:0px;z-index:38;" id="CallBacKsLisTBox">
    <table border=1 bgcolor="#5384C7" width=<?=$CAwidth ?> height=460><TR><TD align=center VALIGN=top> CALLBACKS FOR AGENT <? echo $VD_login ?>:<BR>Click on a callback below to call the customer back now. If you click on a record below to call it, it will be removed from the list.
	<BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:39;" id="NeWManuaLDiaLBox">
    <table border=1 bgcolor="#5384C7" width=<?=$CAwidth ?> height=460><TR><TD align=center VALIGN=top><font color=white> NEW MANUAL DIAL LEAD FOR <? echo "$VD_login in campaign $VD_campaign" ?>:<BR><BR>Enter information below for the new lead you wish to call.
	<BR>
	<? 
	...
	<table><tr>
	<td align=right><font class="body_text"> <font color=white>Dial Code: </td>
	<td align=left><font class="body_text"><input type=text size=7 maxlength=10 name=MDDiaLCodE class="cust_form" value="1">&nbsp; <font color=white>(This is usually a 1 in the USA-Canada)</td>
	</tr><tr>
	<td align=right><font class="body_text"> <font color=white>Phone Number: </td>
	<td align=left><font class="body_text">
	<input type=text size=14 maxlength=12 name=MDPhonENumbeR class="cust_form" value="">&nbsp; <font color=white>(12 digits max - digits only)
	</td>
	</tr><tr>
	<td align=right><font class="body_text"> <font color=white>Search Existing Leads: </td>
	<td align=left><font class="body_text"><input type=checkbox name=LeadLookuP size=1 value="0">&nbsp; <font color=white>(This option if checked will attempt to find the phone number in the system before inserting it as a new lead)</td>
	</tr><tr>

	<td align=right colspan=2><BR><BR><font color=white>If you want to dial a number and have it NOT be added as a new lead, enter in the exact dialstring that you want to call in the Dial Override field below. To hangup this call you will have to open the CALLS IN THIS SESSION link at the bottom of the screen and hang it up by clicking on its channel link there.<BR> &nbsp; </td>
	</tr><tr>
	<td align=right><font class="body_text"> <font color=white>Dial Override: </td>
	<td align=left><font class="body_text"><input type=text size=24 maxlength=20 name=MDDiaLOverridE class="cust_form" value="">&nbsp; <font color=white>(digits only please)
	</td>
	</tr></table>
	<BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:28;" id="WrapupBox">
    <table border=1 bgcolor="#5384C7" width=<?=$CAwidth ?> height=550><TR><TD align=center> Call Wrapup: <span id="WrapupTimer"></span> seconds remaining in wrapup<BR><BR>
...
<span style="position:absolute;left:0px;top:70px;z-index:31;" id="DispoButtonHideA">
    <table border=0 bgcolor="#5384C7" width=165 height=22><TR><TD align=center VALIGN=top></TD></TR></TABLE>
</span>

<span style="position:absolute;left:0px;top:138px;z-index:32;" id="DispoButtonHideB">
    <table border=0 bgcolor="#5384C7" width=165 height=250><TR><TD align=center VALIGN=top>&nbsp;</TD></TR></TABLE>
</span>

<span style="position:absolute;left:0px;top:0px;z-index:33;" id="DispoButtonHideC">
    <table border=0 bgcolor="#5384C7" width=<?=$CAwidth ?> height=47><TR><TD align=center VALIGN=top>Any changes made to the customer information below at this time will not be comitted, You must change customer information before you Hangup the call. </TD></TR></TABLE>
</span>

<span style="position:absolute;left:0px;top:0px;z-index:34;" id="DispoSelectBox">
    <table border=1 bgcolor="#5384C7" width=<?=$CAwidth ?> height=460><TR><TD align=center VALIGN=top><font color=white size=-1> DISPOSITION CALL: <span id="DispoSelectPhonE"></span> &nbsp; &nbsp; &nbsp; <span id="DispoSelectHAspan"><a href="#" onclick="DispoHanguPAgaiN()">Hangup Again</a></span> &nbsp; &nbsp; &nbsp; <span id="DispoSelectMaxMin"><a href="#" onclick="DispoMinimize()">minimize</a></span><BR>
	<span id="DispoSelectContent"> End-of-call Disposition Selection </span>
	<input type=hidden name=DispoSelection><BR>
	<input type=checkbox name=DispoSelectStop size=1 value="0"> <font color=white>PAUSE AGENT DIALING <BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:40;" id="PauseCodeSelectBox">
    <table border=1 bgcolor="#5384C7" width=<?=$CAwidth ?> height=460><TR><TD align=center VALIGN=top> <font color=white>SELECT A PAUSE CODE :<BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:35;" id="CallBackSelectBox">
    <table border=1 bgcolor="#5384C7" width=<?=$CAwidth ?> height=460><TR><TD align=center VALIGN=top> <font color=white><font color=white>Select a CallBack Date :<span id="CallBackDatE"></span><BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:36;" id="CloserSelectBox">
    <table border=1 bgcolor="#5384C7" width=<?=$CAwidth ?> height=460><TR><TD align=center VALIGN=top> CLOSER INBOUND GROUP SELECTION <BR>
...
<span style="position:absolute;left:154px;top:65px;z-index:17;" id="ScriptPanel">
    <table border=0 bgcolor="#5384C7" width=<?=$SSwidth ?> height=<?=$SSheight ?>><TR><TD align=left valign=top><font class="sb_text"><div class="scroll_script" id="ScriptContents">VICIDIAL SCRIPT</div></font></TD></TR></TABLE>
</span>
...
<table frame=vsides BGCOLOR="#5384C7" id="MaiNfooter" width=<?=$MNwidth ?>><tr height=32><td height=32><font face="Arial,Helvetica" size=1>VICIDIAL web-client version: <? echo $version ?> &nbsp; &nbsp; BUILD: <? echo $build ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Server: <? echo $server_ip ?>  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</font><BR>
...
<TABLE frame=vsides BGCOLOR=#5384C7 width=<?=$MNwidth ?> id="MainTable">
<TR><TD colspan=3><font class="body_text" color=white> STATUS: <span id="MainStatuSSpan"></span></font></TD></TR>
<tr><td colspan=3><span id="busycallsdebug"></span></td></tr>
<tr><td width=150 height=330 align=left valign=top>
<font class="body_text"><center>
<span STYLE="background-color: #5384C7" id="DiaLControl"><a href="#" onclick="ManualDialNext('','','','','');"><IMG SRC="./images/vdc_LB_dialnextnumber_OFF.gif" border=0 alt="Dial Next Number"></a></span><BR>
...
?> -->
<font color=white>RECORDING FILE: </font><BR>
</center>
<font class="body_tiny"><span id="RecorDingFilename"></span></font><BR>
<font color=white>RECORD ID: </font><font class="body_small"><span id="RecorDID"></span></font><BR>
<center>
...
<div class="text_input" id="SendDTMFdiv"><span STYLE="background-color: #CCCCCC" id="SendDTMF"><a href="#" onclick="SendConfDTMF('<?=$session_id ?>');return false;"><IMG SRC="./images/vdc_LB_senddtmf.gif" border=0 alt="Send DTMF" align=middle></a> <input type=text size=6 name=conf_dtmf class="cust_form" value="" maxlength=50></div></span><BR>
<span STYLE="background-color: #FFCCFF" id="RepullControl"></span><BR>
...
<table><tr>
<td align=right colspan=3><font class="body_text"><font color=white>Seconds:</font>
<!--td align=left colspan=2 --><font class="body_text"><input type=text size=3 name=SecondS class="cust_form" value="">&nbsp;&nbsp;&nbsp;<font color=white>Channel:</font> <input type=text size=6 name=callchannel class="cust_form" value="">&nbsp;&nbsp;&nbsp;<font color=white>Cust Time:</font> <input type=text size=20 name=custdatetime class="cust_form" value=""></td>
</tr>
<tr>
<td colspan=3 align=center><font color=yellow>Customer Information</font><span id="CusTInfOSpaN"></span></td>
</tr>
<tr>
<td align=right><font class="body_text"> <font color=white>Title:</font> </td>
<td align=left colspan=2><font class="body_text"><input type=text size=4 name=title maxlength=4 class="cust_form" value="">&nbsp; <font color=white>First:</font> <input type=text size=17 name=first_name maxlength=30 class="cust_form" value="">&nbsp; <font color=white>MI:</font> <input type=text size=1 name=middle_initial maxlength=1 class="cust_form" value="">&nbsp; <font color=white>Last:</font> <input type=text size=20 name=last_name maxlength=30 class="cust_form" value=""></td>
</tr>
<tr>
<td align=right><font class="body_text"> <font color=white>Address1:</font> </td>
...
<tr>
<td align=right><font class="body_text"> <font color=white>Address2:</font> </td>
<td align=left><font class="body_text"><input type=text size=26 name=address2 maxlength=100 class="cust_form" value=""></td><td align=right><font class="body_text"><font color=white>Address3:</font> <input type=text size=26 name=address3 maxlength=100 class="cust_form" value=""></td>
</tr>
<tr>
<td align=right><font class="body_text"> <font color=white>City:</font> </td>
<td align=left><font class="body_text"><input type=text size=26 name=city maxlength=50 class="cust_form" value="">&nbsp;</td><td align=right> <font class="body_text"><font color=white>State:</font> <input type=text size=2 name=state maxlength=2 class="cust_form" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color=white>ZipCode:</font> <input type=text size=9 name=postal_code maxlength=10 class="cust_form" value=""></td>
</tr>
<tr>
<td align=right><font class="body_text"> <font color=white>State:</font> </td>
<td align=left><font class="body_text"><input type=text size=26 name=province maxlength=50 class="cust_form" value="">&nbsp;</td><td align=right> <font class="body_text"><font color=white>Vendor ID:</font> <input type=text size=26 name=vendor_lead_code maxlength=20 class="cust_form" value=""></td>
</tr>
<tr>
<td align=right><font class="body_text"> <font color=white>Phone:</font> </td>
<td colspan=2><table width=100%><tr><td align=left colspan=2><font class="body_text"><input type=text size=11 name=phone_number maxlength=12 class="cust_form" value=""></td><td align=right><font class="body_text"><font color=white>PhoneCode:&nbsp;</font><input type=text size=4 name=phone_code maxlength=10 class="cust_form" value=""></td><td align=right><font class="body_text"><font color=white>Alt. Phone:&nbsp;</font><input type=text size=12 name=alt_phone maxlength=12 class="cust_form" value=""></td></td></tr></table>
</tr>
<tr>
<td align=right><font class="body_text"> <font color=white>Show:</font> </td>
<td align=left><font class="body_text"><input type=text size=26 name=security_phrase maxlength=100 class="cust_form" value="">&nbsp;</td><td align=right> <font class="body_text"><font color=white>Email:</font> <input type=text size=26 name=email maxlength=70 class="cust_form" value=""></td>
</tr>
<tr>
<td align=right valign=top><font class="body_text"> <font color=white>Comments:</font> </td>
