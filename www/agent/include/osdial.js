			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if ( (MDnextCID == "HOPPER EMPTY") || (MDnextCID == "DNC NUMBER") )
						...
						document.osdial_form.security_phrase.value	= MDnextResponse_array[25];
...
?>
						...
						"&security_phrase=" + document.osdial_form.security_phrase.value + 
				...
				xmlhttp.onreadystatechange = function() 
					...
					//	alert(xmlhttp.responseText);
						...
						if (MDSnextCID == "LEAD NOT REVERTED")
							...
							document.osdial_form.security_phrase.value='';
				...
				xmlhttprequestcheckauto.onreadystatechange = function() 
					...
					//		alert(xmlhttprequestcheckauto.responseText);
						...
						//	DialLog("start");
							...
							document.osdial_form.security_phrase.value	= check_VDIC_array[29];
							var REGcommentsNL = new RegExp("!N","g");
			...
			if (xmlhttprequestrepull) {
				...
				xmlhttprequestrepull.onreadystatechange = function() { 
					...
					//		alert(xmlhttprequestrepull.responseText);
							...
							document.osdial_form.security_phrase.value	= check_RPLD_array[22];
   ...
   // Put [ERR] in output if %ZZ is invalid.
	...
	encoded=utf8_decode(xtest);
	   ...
	   if (scriptformat == 'YES')
		...
		var SCsecurity_phrase = document.osdial_form.security_phrase.value;
