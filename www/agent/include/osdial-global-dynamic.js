...
var hide_xfer_local_closer='<?=$hide_xfer_local_closer?>';
var hide_xfer_dial_override='<?=$hide_xfer_dial_override?>';
var hide_xfer_hangup_xfer='<?=$hide_xfer_hangup_xfer?>';
var hide_xfer_leave_3way='<?=$hide_xfer_leave_3way?>';
var hide_xfer_dial_with='<?=$hide_xfer_dial_with?>';
var hide_xfer_hangup_both='<?=$hide_xfer_hangup_both?>';
var hide_xfer_blind_xfer='<?=$hide_xfer_blind_xfer?>';
var hide_xfer_park_dial='<?=$hide_xfer_park_dial?>';
var hide_xfer_blind_vmail='<?=$hide_xfer_blind_vmail?>';
