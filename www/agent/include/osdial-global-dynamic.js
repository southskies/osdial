...
var DiaLControl_auto_HTML="<span class=PauseButtonOff>Pause</span><a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADready');\"><span class=ResumeButton>Resume</span></a>";
...
var DiaLControl_auto_HTML_OFF="<span class=PauseButtonOff>Pause</span><span class=ResumeButtonOff>Resume</span>";
...
var DiaLControl_auto_HTML_ready="<a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADpause','NEW_ID');\"><span class=PauseButton>Pause</span></a><span class=ResumeButtonOff>Resume</span>";
...
var DiaLControl_manual_HTML="<a href=\"#\" onclick=\"ManualDialNext('','','','','');\"><span class=DialNextButton>Dial Next Number</span></a>";
...
var image_LB_dialnextnumber=new Image(); image_LB_dialnextnumber.src="<span class=DialNextButton>Dial next number</span>";
var image_LB_dialnextnumber_OFF=new Image(); image_LB_dialnextnumber_OFF.src="<span class=DialNextButtonOff>Dial next number</span>";
...
var image_LB_hangupcustomer=new Image(); image_LB_hangupcustomer.src="<span class=HangupButton>Hangup Customer</span>";
var image_LB_hangupcustomer_OFF=new Image(); image_LB_hangupcustomer_OFF.src="<span class=HangupButtonOff>Hangup Customer</span>";
var image_LB_parkcall=new Image(); image_LB_parkcall.src="<span class=ParkButton>Park Call</span>";
var image_LB_parkcall_OFF=new Image(); image_LB_parkcall_OFF.src="<span class=ParkButtonOff>Park Call</span>";
...
var image_LB_startrecording=new Image(); image_LB_startrecording.src="<span class=RecordingButtonStart>Start Recording</span>";
var image_LB_startrecording_OFF=new Image(); image_LB_startrecording_OFF.src="<span class=RecordingButtonStartOff>Start Recording</span>";
var image_LB_stoprecording=new Image(); image_LB_stoprecording.src="<span class=RecordingButtonStop>Stop Recording</span>";
var image_LB_stoprecording_OFF=new Image(); image_LB_stoprecording_OFF.src="<span class=RecordingButtonStopOff>Stop Recording</span>";
...
var image_LB_webform2=new Image(); image_LB_webform2.src="<span class=WebFormButton>Web Form 2</span>";
var image_LB_webform=new Image(); image_LB_webform.src="<span class=WebFormButton>Web Form 1</span>";
var image_LB_webform2_OFF=new Image(); image_LB_webform2_OFF.src="<span class=WebFormButtonOff>Web Form 2</span>";
var image_LB_webform_OFF=new Image(); image_LB_webform_OFF.src="<span class=WebFormButtonOff>Web Form 2</span>";
