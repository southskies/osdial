	...
	function volume_control(taskdirection,taskvolchannel,taskagentmute) 
		...
		if (taskagentmute=='AgenT')
			...
			if (taskdirection=='MUTING')
				{
				document.getElementById("AgentMuteSpan").innerHTML = "<a href=\"#CHAN-" + agentchannel + "\" onclick=\"volume_control('UNMUTE','" + agentchannel + "','AgenT');return false;\"><IMG SRC=\"./images/vdc_volume_UNMUTE.gif\" BORDER=1></a>";
				}
			else
				{
...
<td colspan=2 align=center><font color=#1C4754>Customer Information:</font><span id="CusTInfOSpaN"></span></td>
</tr><tr>
