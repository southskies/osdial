...
if ($relogin == 'YES') {
	...
	echo "<BODY BGCOLOR=WHITE MARGINHEIGHT=0 MARGINWIDTH=0 name=vicidial>\n";
...
if ($user_login_first == 1) {
	if ( (strlen($VD_login)<1) or (strlen($VD_pass)<1) or (strlen($VD_campaign)<1) ) {
		...
		echo "<TD ALIGN=LEFT VALIGN=BOTTOM><b>&nbsp;&nbsp;<font color=white>OSDial</b><!--IMG SRC=\"./images/vdc_tab_vicidial.gif\" BORDER=0 --></TD>";
...
if ($WeBRooTWritablE > 0) {$fp = fopen ("./vicidial_auth_entries.txt", "a");}
	$VDloginDISPLAY=0;
...
if (!$authphone)
	...
	if (strlen($web_form_address2)>0) {
		$VICIDiaL_web_form_address2 = "$web_form_address2";
		print "<!-- CAMPAIGN CUSTOM WEB FORM2:   |$VICIDiaL_web_form_address2| -->\n";
	} else {
		$VICIDiaL_web_form_address = "$VICIDiaL_web_URL";
		print "<!-- CAMPAIGN DEFAULT WEB FORM2:  |$VICIDiaL_web_form_address| -->\n";
		$VICIDiaL_web_form_address_enc = rawurlencode($VICIDiaL_web_form_address);
	}
	$VICIDiaL_web_form_address_enc = rawurlencode($VICIDiaL_web_form_address);
...
<BODY onload="begin_all_refresh();"  onunload="BrowserCloseLogout();" name=vicidial>
...
?>
	...
	<!-- =============================   Here is the main VICIDIAL display panel  ============================= -->
