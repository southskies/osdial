...
if ($user_login_first == 1)
{
	...
	echo "<TABLE WIDTH=460 CELLPADDING=0 CELLSPACING=0 BGCOLOR=365783><TR BGCOLOR=365783>";
	echo "<TD ALIGN=LEFT VALIGN=BOTTOM><b>&nbsp;&nbsp;<font color=white>VICIDIAL</b><!--IMG SRC=\"./images/vdc_tab_vicidial.gif\" BORDER=0 --></TD>";
	...
	else
	{
		...
		echo "<FORM  NAME=vicidial_form ID=vicidial_form ACTION=\"$agcPAGE\" METHOD=POST>\n";
		echo "<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
		echo "<BR><BR><BR><CENTER><TABLE WIDTH=460 CELLPADDING=0 CELLSPACING=0 BGCOLOR=365783><TR BGCOLOR=365783>";
...
?>
	...
	var panel_bgcolor = '365783'; //#E0C2D6
					...
					//	alert(xmlhttprequestcheckconf.responseText);
						...
						if ( (conf_channels_xtra_display == 1) || (conf_channels_xtra_display == 0) )
							...
							if (live_conf_calls > 0)
								...
								var conv_start=-1;
								var live_conf_HTML = "<font face=\"Arial,Helvetica\"><B>LIVE CALLS IN YOUR SESSION:</B></font><BR><TABLE WIDTH=<?=$SDwidth ?>><TR BGCOLOR=365783><TD><font class=\"log_title\">#</TD><TD><font class=\"log_title\">REMOTE CHANNEL</TD><TD><font class=\"log_title\">HANGUP</TD><TD><font class=\"log_title\">VOLUME</TD></TR>";
...
// GLOBAL FUNCTIONS
	...
	function MainPanelToFront(resumevar)
		{
		document.getElementById("MainTable").style.backgroundColor="365783"; //#E0C2D6
		document.getElementById("MaiNfooter").style.backgroundColor="365783";
		hideDiv('ScriptPanel');
		showDiv('MainPanel');
		if (resumevar != 'NO')
			{
	...
	function ScriptPanelToFront()
		{
		showDiv('ScriptPanel');
		document.getElementById("MainTable").style.backgroundColor="365783";
		document.getElementById("MaiNfooter").style.backgroundColor="365783";
		panel_bgcolor='365783';
		document.getElementById("MainStatuSSpan").style.background = panel_bgcolor;
		}
...
<span style="position:absolute;left:0px;top:0px;z-index:38;" id="CallBacKsLisTBox">
    <table border=1 bgcolor="365783" width=<?=$CAwidth ?> height=460><TR><TD align=center VALIGN=top> CALLBACKS FOR AGENT <? echo $VD_login ?>:<BR>Click on a callback below to call the customer back now. If you click on a record below to call it, it will be removed from the list.
	<BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:39;" id="NeWManuaLDiaLBox">
    <table border=1 bgcolor="365783" width=<?=$CAwidth ?> height=460><TR><TD align=center VALIGN=top><font color=white> NEW MANUAL DIAL LEAD FOR <? echo "$VD_login in campaign $VD_campaign" ?>:<BR><BR>Enter information below for the new lead you wish to call.
	<BR>
	<? 
...
<span style="position:absolute;left:0px;top:0px;z-index:28;" id="WrapupBox">
    <table border=1 bgcolor="365783" width=<?=$CAwidth ?> height=550><TR><TD align=center> Call Wrapup: <span id="WrapupTimer"></span> seconds remaining in wrapup<BR><BR>
...
<span style="position:absolute;left:0px;top:70px;z-index:31;" id="DispoButtonHideA">
    <table border=0 bgcolor="365783" width=165 height=22><TR><TD align=center VALIGN=top></TD></TR></TABLE>
</span>

<span style="position:absolute;left:0px;top:138px;z-index:32;" id="DispoButtonHideB">
    <table border=0 bgcolor="365783" width=165 height=250><TR><TD align=center VALIGN=top>&nbsp;</TD></TR></TABLE>
</span>

<span style="position:absolute;left:0px;top:0px;z-index:33;" id="DispoButtonHideC">
    <table border=0 bgcolor="365783" width=<?=$CAwidth ?> height=47><TR><TD align=center VALIGN=top>Any changes made to the customer information below at this time will not be comitted, You must change customer information before you Hangup the call. </TD></TR></TABLE>
</span>

<span style="position:absolute;left:0px;top:0px;z-index:34;" id="DispoSelectBox">
    <table border=1 bgcolor="365783" width=<?=$CAwidth ?> height=460><TR><TD align=center VALIGN=top><font color=white size=-1> DISPOSITION CALL: <span id="DispoSelectPhonE"></span> &nbsp; &nbsp; &nbsp; <span id="DispoSelectHAspan"><a href="#" onclick="DispoHanguPAgaiN()">Hangup Again</a></span> &nbsp; &nbsp; &nbsp; <span id="DispoSelectMaxMin"><a href="#" onclick="DispoMinimize()">minimize</a></span><BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:40;" id="PauseCodeSelectBox">
    <table border=1 bgcolor="365783" width=<?=$CAwidth ?> height=460><TR><TD align=center VALIGN=top> <font color=white>SELECT A PAUSE CODE :<BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:35;" id="CallBackSelectBox">
    <table border=1 bgcolor="365783" width=<?=$CAwidth ?> height=460><TR><TD align=center VALIGN=top> <font color=white><font color=white>Select a CallBack Date :<span id="CallBackDatE"></span><BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:36;" id="CloserSelectBox">
    <table border=1 bgcolor="365783" width=<?=$CAwidth ?> height=460><TR><TD align=center VALIGN=top> CLOSER INBOUND GROUP SELECTION <BR>
...
<span style="position:absolute;left:154px;top:65px;z-index:17;" id="ScriptPanel">
    <table border=0 bgcolor="365783" width=<?=$SSwidth ?> height=<?=$SSheight ?>><TR><TD align=left valign=top><font class="sb_text"><div class="scroll_script" id="ScriptContents">VICIDIAL SCRIPT</div></font></TD></TR></TABLE>
</span>
...
<table frame=vsides BGCOLOR="365783" id="MaiNfooter" width=<?=$MNwidth ?>><tr height=32><td height=32><font face="Arial,Helvetica" size=1>VICIDIAL web-client version: <? echo $version ?> &nbsp; &nbsp; BUILD: <? echo $build ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Server: <? echo $server_ip ?>  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</font><BR>
...
<TABLE frame=vsides BGCOLOR=365783 width=<?=$MNwidth ?> id="MainTable">
...
<span STYLE="background-color: 365783" id="DiaLControl"><a href="#" onclick="ManualDialNext('','','','','');"><IMG SRC="./images/vdc_LB_dialnextnumber_OFF.gif" border=0 alt="Dial Next Number"></a></span><BR>
