...
if [ $imports -lt 1 ]; then
	...
	BOGONS=(    0.0.0.0/8  10.0.0.0/8  39.0.0.0/8  102.0.0.0/8  103.0.0.0/8    104.0.0.0/8   106.0.0.0/8     127.0.0.0/8 169.254.0.0/16
		172.16.0.0/12 179.0.0.0/8 185.0.0.0/8 192.0.0.0/24 192.0.2.0/24 192.168.0.0/16 198.18.0.0/15 198.51.100.0/24 203.0.103.0/24 )
