...
ALTER TABLE osdial_campaigns ADD web_form_address2 VARCHAR(255) default '/osdial/agent/webform_redirect.php';
ALTER TABLE osdial_inbound_groups ADD web_form_address2 VARCHAR(255) default '/osdial/agent/webform_redirect.php';
