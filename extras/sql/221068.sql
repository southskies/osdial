...
ALTER TABLE osdial_hopper MODIFY alt_dial ENUM('NONE','ALT','ADDR3','AFFAP1','AFFAP2','AFFAP3','AFFAP4','AFFAP5','AFFAP6','AFFAP7','AFFAP8','AFFAP9') default 'NONE';##|##
 ##    Updates to osdial_hopper for AFF alt_phone numbers.;

ALTER TABLE osdial_auto_calls MODIFY alt_dial ENUM('NONE','MAIN','ALT','ADDR3','AFFAP1','AFFAP2','AFFAP3','AFFAP4','AFFAP5','AFFAP6','AFFAP7','AFFAP8','AFFAP9') default 'NONE';##|##
